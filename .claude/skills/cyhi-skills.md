...
Read `tracks.md` for the full brief on all four tracks, their hard constraints, and what judges reward. Load it when you know which track the team is on, or when asked to compare.
